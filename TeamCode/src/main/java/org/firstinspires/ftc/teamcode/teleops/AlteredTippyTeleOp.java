...
@TeleOp(name = "AlteredTippyTeleOp", group = "TeleOp")
public class AlteredTippyTeleOp extends OpMode {
...
//		telemetry.addLine( "Grabber Open/Closed Toggle: [Gp1] x" );
	...
	public void autoSlantBucket( ) {
		...
		if( robot.lift.getPositionInch( ) < Lift.LIFT_UP_SWITCH_LIMIT ) // at bottom
			robot.bucket.setAngle( RRTippyBot.BUCKET_ANGLE_INTAKE );
