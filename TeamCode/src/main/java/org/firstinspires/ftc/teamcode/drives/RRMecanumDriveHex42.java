...
public class RRMecanumDriveHex42 extends MecanumDrive {
	...
	public RRMecanumDriveHex42( HardwareMap hardwareMap, boolean loadMap, String mapName ) {
		...
		setLocalizer( new TrackingCameraLocalizer(hardwareMap, new Pose2d( CAMERA_X, CAMERA_Y, 0 ), null, loadMap, mapName, TrackingCameraLocalizer.CardinalDirection.EAST) );
