...
public class CubeWeightUtil {

	Telemetry telemetry;
	private OpenCvWebcam webcam;
	private CubeWeightDetector pipeline;

	public CubeWeightUtil( HardwareMap hw, String webcamName, Telemetry t ) {
		telemetry = t;
		setup( hw, webcamName );
	}
	...
	public void setup( HardwareMap hw, String webcamName ) {
		...
		pipeline = new CubeWeightDetector( telemetry );
	...
	public CubeWeightDetector.FreightType getFreightType( ) {
		return pipeline.getFreightType( );
	}
}
